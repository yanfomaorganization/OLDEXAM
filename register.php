	...
	<div class="container">
	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
	        <ul class="nav navbar-nav">
		        <li class="dropdown">
		            <a href="login.html"><i class="fa fa-user"></i><span>Logout</span></a>
		        </li>
	   ...
	   <div class="container">
        ...
        <p><?php echo $message;?></p>
                ...
                <div class="form-group">
                   Nom <input type="text" autocomplete="off" class="required form-control" placeholder="Name *" name="Name" value="">
                </div>
                <div class="form-group">
                   Nom d'utilisateur <input type="text" autocomplete="off" class="required form-control" placeholder="Username *" name="username" value="">
                </div>
                <div class="form-group">
                    Mot de passe <input type="password" class="required form-control" placeholder="Password *" name="password" value="">
                </div>
                <div class="form-group">
                    encore<input type="password" class="required form-control" placeholder="Conform Password *" name="Conform Password" value="">
                </div>
                <div class="form-group">
                   Email <input type="text" autocomplete="off" class="required form-control" placeholder="Email *" name="email" value="">
                </div>
                <div class="form-group">
                   encore <input type="text" autocomplete="off" class="required form-control" placeholder="Conform Email *" name="conform email" value="">
                </div>
                <div class="form-group">
